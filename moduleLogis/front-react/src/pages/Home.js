...
import SaveForm from '../logis/SaveForm';
			...
			<Container>
				<Header>
					<Navbar appearance="inverse">
						<Nav>
							<Nav.Item href="/App" icon={<Icon as={SiteIcon} />}>
								Home
							</Nav.Item>
							...
							>
								...
								<Nav.Item >
									<Link to="/SaveForm" className='nav-link'>출고관리</Link>
								</Nav.Item>
								<Nav.Item>
									<Link to="/Detail" className='nav-link'>창고관리</Link>
								</Nav.Item>
							</Nav.Menu>
							<Nav.Menu
								icon={<Icon as={PeopleRuleIcon} />}
				...
				<Content>
					<Routes>
						...
						<Route path="/SaveForm" element={<SaveForm />} /> {/*리스트*/}
						<Route path="/board:b_num" element={<Detail />} /> {/*리스트*/}
